        ...
        if(type.length > 0 && i<type.length){
            switch (type[i].substring(0,3)) {
                ...
                case 'dat': // Formato de Data dia/mes/ano
                    ...
                    break
                case 'dtm': // Formato de Data dia/mes/ano hora:min
                    html = obj[arr[0]] != null ? obj[arr[0]].substring(8,10)+'/'+ obj[arr[0]].substring(5,7)+'/'+obj[arr[0]].substring(0,4)+' '+obj[arr[0]].substr(10,6) : ''
                    break   
                case 'Low': // Lower Case
